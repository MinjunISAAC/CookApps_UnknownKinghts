...
namespace InGame.ForUnit
{
    public class Unit : MonoBehaviour
    {
        ...
        // Variables
        // --------------------------------------------------
        private EState    _unitState       = EState.Unknown;
        ...
        private void _ChangeToState(EState state, float duration, Action doneCallBack)
        {
            ...
            switch (_unitState)
            {
                case EState.Intro  : _State_Intro (); break;
        ...
        private void _State_Intro () => _co_CurrentState = StartCoroutine(_Co_Intro ());
